                        ...
                        <div>
                          <span class="disIb">
                            ...
                            <FormItem label="简称 :" prop="accAbb">
                              <Input v-model="formValidate.accAbb" placeholder="请输入..." type="text" @on-change="interceptString"><span slot="append">{{accountNumber}}</span></Input>
                            </FormItem>
                          ...
                          <span class="disIb" style="float:right">
                            <FormItem label="账号 :" prop="accId">
                              <Input v-model="formValidate.accId" placeholder="请输入..." type="text"></Input>
                            </FormItem>
                      ...
                      <div class="line-flex">
                        <span class="disIb line-span">
                          ...
                          <FormItem label="不直连原因 :" style="display: inline-block;" v-if="!formValidate.isBankUnit" prop="noLinkRe">
                            <Input v-model="formValidate.noLinkRe" placeholder="请输入..." type="text" class="inputSty"></Input>
                          </FormItem>
                          <FormItem label="不直连原因 :" style="display: inline-block;"  v-if="formValidate.isBankUnit">
                            <Input v-model="formValidate.noLinkRe" placeholder="请输入..." type="text" class="inputSty" disabled></Input>
                          </FormItem>
                        </span>
                        <span class="disIb line-span">
                          <div class="detailTitle" :style="{width:detailTitle +'px'}">
                          ...
                          <FormItem label="透支限额 :" prop="overAmount" style="display: inline-block;" v-if="formValidate.isAllowOver">
                            <Input v-model="formValidate.overAmount" placeholder="请输入..." type="text" class="inputSty">
                              <span slot="append">元</span>
                            </Input>
                          </FormItem>
                          <FormItem label="透支限额 :" style="display: inline-block;" v-if="!formValidate.isAllowOver">
                            <Input v-model="formValidate.overAmount" placeholder="请输入..." type="text" class="inputSty" disabled>
                              <span slot="append">元</span>
                            </Input>
                          </FormItem>
                        </span>
                      ...
                      <div class="line-flex">
                        ...
                        <span class="disIb line-span">
                          ...
                          <FormItem label="重大监管原因 :" prop="superviseRe" style="display: inline-block;" v-if="formValidate.isSuperviseAcc">
                            <Input v-model="formValidate.superviseRe" placeholder="请输入..." type="text" class="inputSty"></Input>
                          </FormItem>
                          <FormItem label="重大监管原因 :" style="display: inline-block;" v-if="!formValidate.isSuperviseAcc">
                            <Input v-model="formValidate.superviseRe" placeholder="请输入..." type="text" class="inputSty" disabled></Input>
                          </FormItem>
                        </span>
                      </div>
                      <div class="line-flex">
              ...
              <div slot="content" class="account-content">
                <span class="disIb">
                  <FormItem label="账户经办人 :" prop="accOperator">
                    <Input v-model="formValidate.accOperator" placeholder="姓名" type="text" class="InputWid inputMar"></Input>
                    <Input v-model="formValidate.operatorTel" placeholder="联系方式" type="text" class="InputWid"></Input>
                  </FormItem>
                </span>
                <span class="disIb">
                  <FormItem label="大额联系人 :" prop="accLargePeoson">
                    <Input v-model="formValidate.accLargePeoson" placeholder="姓名" type="text" class="InputWid inputMar"></Input>
                    <Input v-model="formValidate.largerPersonTel" placeholder="联系方式" type="text" class="InputWid"></Input>
                  </FormItem>
                </span>
                <span class="disIb">
                  <FormItem label="银行客户经理 :" prop="bankManage">
                    <Input v-model="formValidate.bankManage" placeholder="姓名" type="text" class="InputWid inputMar"></Input>
                    <Input v-model="formValidate.managerTel" placeholder="联系方式" type="text" class="InputWid"></Input>
                  </FormItem>
                </span>
              </div>
            </account-card>
...
export default {
  ...
  methods: {
    ...
    async insertOrUpdate(item) {
      let data = {};
      item.accAbb = item.accAbb.concat(this.accountNumber);
      item.bankid = item.bankid.bankUnionCode;
      item.accAbb = item.accAbb + this.accountNumber;
      if (item.id) {
        //存在id 就走修改
        requestSuccess(this, await accountRegistSave(item), true);
      } else {
        data = item;
        delete data.id; //删除id 添加新的保存
        this.formValidate = requestSuccess(
          this,
          await accountRegistSave(item),
          true
        );
      }
    },
