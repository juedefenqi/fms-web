                          ...
                          <span class="disIb">
                            <FormItem label="开户单位 :" prop="openAccId">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.openAccId"
                              >
                                <Option
                            ...
                            <FormItem label="账户性质 :" prop="accPro">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.accPro"
                              >
                                <Option
                            ...
                            <FormItem label="币别 :" prop="currency">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.currency"
                              >
                                <Option
                          ...
                          <span class="disIb">
                            ...
                            <FormItem label="开户银行 :">
                              <Select
                                ...
                                :placeholder="formValidate.bankid"
                              >
                                <Option
                            ...
                            <FormItem label="开户日期 :">
                              ...
                              <Row class="date-line">
                                <pickerDate
                                  ...
                                  type="date"
                                  class="date-w"
                                  :placeholder="formValidate.accOpenDate"
                          ...
                          <span class="disIb" style="float:right">
                            ...
                            <FormItem label="关联实体账户 :" v-if="formValidate.isVirtualAcc"  prop="entityAcc">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.entityAcc" 
                              >
                                <Option
                        ...
                        <div>
                          <FormItem label="备注 :" prop="comment">
                            <Input
                              ...
                              type="textarea"
                              :placeholder="formValidate.comment" 
                            />
                          </FormItem>
                        </div>
                      </div>
                          ...
                          <span class="disIb">
                            <FormItem label="使用单位 :" prop="unitId">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.unitId" 
                              >
                                <Option
                            ...
                            <FormItem label="账户用途 :" prop="accUse">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.accUse"
                              >
                                <Option
                          ...
                          <span class="disIb">
                            <FormItem label="使用项目 :">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.projectId"
                              >
                                <Option
                            ...
                            <FormItem label="收支属性 :" prop="balanceAttribute" style="display: inline-block;">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.balanceAttribute"
                              >
                                <Option
                          ...
                          <span class="disIb">
                            ...
                            <FormItem label="账户管理属性 :" prop="acManageAttribute" style="display: inline-block;">
                              <Select
                                ...
                                filterable
                                :placeholder="formValidate.acManageAttribute"
                              >
                                <Option
                      ...
                      <div class="line-flex">
                        ...
                        <span class="disIb line-span">
                          ...
                          <FormItem label="透支限额 :" prop="overAmount" style="display: inline-block;" v-if="formValidate.isAllowOver">
                            <Input v-model="formValidate.overAmount" :placeholder="formValidate.overAmount" type="text" class="inputSty">
                              <span slot="append">元</span>
                            </Input>
                          </FormItem>
                          <FormItem label="透支限额 :" style="display: inline-block;" v-if="!formValidate.isAllowOver">
                            <Input v-model="formValidate.overAmount" :placeholder="formValidate.overAmount" type="text" class="inputSty" disabled>
                              <span slot="append">元</span>
                            </Input>
                          </FormItem>
                        </span>
                        ...
                        <span class="disIb line-span">
                          ...
                          <FormItem label="归集主账户 :" prop="collectionAcc" style="display: inline-block;" v-if="formValidate.isUnderAcc">
                            <Select
                              ...
                              filterable
                              :placeholder="formValidate.collectionAcc"
                            >
                              <Option
                                v-for="item in getCollectionDate"
                                :value="item.id"
                        ...
                        <span class="disIb line-span">
                          ...
                          <FormItem label="抵押或限制使用项目 :" prop="accNotAllow" style="display: inline-block;" v-if="formValidate.isControlAcc">
                            <Select
                              ...
                              filterable
                              :placeholder="formValidate.accNotAllow"
                            >
                              <Option
