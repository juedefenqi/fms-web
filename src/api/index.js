...
// 数据字典
//相关参数
//acc_pro=账户性质;acc_use=账户用途;balance_att=账户收支属性;acc_manage_att=账户管理属性;currency=币别;
//accUseUnit == 使用单位accMoneyCenter == 资金中心accManageUnit ==管理单位accOpenUnit == 开户单位
export const dictData = (ids, params) => {
...
export const ApplyInfo = params => {
  //表单查看数据回显接口·
  return getRequest("/fcBankAccount/selectAccountApplyInfo", params);
};
